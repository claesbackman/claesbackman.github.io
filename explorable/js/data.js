...
window.D = (function () {
  ...
  var C = [
    ...
    ["USA",          "United States",    "English",    "$50,000",          0.57, 0.13, 0.40, 0.60, 0.70, 650, null,  null,  null, null, null,  18.44,  0.12,  51.3,  0.52,  0.05,  1.2,   29,    18.0, 33.7, 97.5, null,  false,  96.8, 2.9,  0,    0   ],
    ["UK",           "United Kingdom",   "English",    "\u00a340,000",          0.58, 0.13, 0.40, 0.60, 0.75, 650, 0.7,   -0.8,  2.2,  0.352, 1.000, 19.12,  0.05,  54.2,  0.49,  0.09,  4.5,   113,   89.8, 39.5, 89.0, -14.3, false,  98.0, 2.0,  0,    0   ],
    ["Sweden",       "Sweden",           "Swedish",    "500 000 kr",       0.57, 0.13, 0.40, 0.50, 0.75, 649, -0.2,  -3.7,  3.4,  0.931, 1.000, 19.25,  0.05,  66.3,  0.48,  0.09,  4.4,   110,   47.6, 14.3, 90.7, -10.0, false,  99.8, 0.2,  0,    0   ],
    ["Finland",      "Finland",          "Finnish",    "45 000 \u20ac",     0.55, 0.15, 0.35, 0.60, 0.75, 648, -2.4,  -5.0,  0.4,  0.086, 0.602, 18.52,  -0.28, 65.7,  0.52,  0.03,  0.4,   11,    57.4, 20.4, 89.5, -19.1, false,  100.0, 0,   0,    0   ],
    ["Germany",      "Germany",          "German",     "45.000 \u20ac",      0.53, 0.14, 0.30, 0.60, 0.70, 650, -4.0,  -7.7,  -0.4, 0.034, 0.335, 18.52,  -0.04, 53.3,  0.52,  0.01,  0.1,   2,     63.1, 21.2, 99.0, -21.1, false,  88.6, 0.2,  0,    11.2],
    ["France",       "France",           "French",     "45 000 \u20ac",     0.52, 0.14, 0.30, 0.60, 0.70, 649, -5.4,  -7.5,  -3.4, 0.001, 0.001, 18.52,  -0.03, 70.0,  0.52,  0.00,  0.0,   0,     77.0, 18.9, 96.6, -15.7, false,  97.8, 2.2,  0,    0   ],
    ["Spain",        "Spain",            "Spanish",    "45.000 \u20ac",     0.53, 0.12, 0.40, 0.60, 0.70, 648, -4.4,  -6.3,  -2.5, 0.001, 0.001, 18.53,  -0.16, 86.3,  0.52,  0.01,  0.0,   1,     79.1, 24.2, 99.4, -20.4, false,  96.4, 3.6,  0,    0   ],
    ["Japan",        "Japan",            "Japanese",   "750\u4e07\u5186",           0.58, 0.14, 0.35, 0.60, 0.70, 650, 1.2,   -2.1,  4.8,  0.492, 1.000, 20.36,  -0.36, 42.4,  0.43,  0.15,  14.7,  368,   54.3, 24.3, 96.4, -28.6, false,  99.7, 0.2,  0,    0   ],
    ["Brazil",       "Brazil",           "Portuguese", "R$250.000,00",       0.46, 0.14, 0.30, 0.40, 0.70, 650, -11.0, -15.0, -6.9, 0.001, 0.002, 27.54,  -0.25, 97.5,  0.23,  0.23,  57.8,  1461,  93.8, 58.8, 97.2, -1.7,  true,   13.1, 86.7, 0,    0   ],
    ["Australia",    "Australia",        "English",    "A$75,000",       0.58, 0.12, 0.40, 0.60, 0.70, 650, 0.6,   -0.7,  1.9,  0.343, 1.000, 19.01,  0.14,  53.0,  0.49,  0.08,  3.9,   98,    86.2, 30.9, 94.9, -17.1, false,  98.3, 1.5,  0,    0   ],
    ["Canada",       "Canada",           "English",    "C$70,000",       0.56, 0.13, 0.40, 0.60, 0.70, 650, -1.1,  -2.1,  -0.1, 0.029, 0.317, 18.50,  0.18,  45.1,  0.52,  0.04,  0.8,   21,    77.4, 33.5, 99.8, -12.3, false,  97.2, 2.6,  0,    0   ],
    ["India",        "India",            "English",    "INR 4,000,000",    0.55, 0.12, 0.40, 0.60, 0.70, 650, -1.9,  -3.3,  -0.4, 0.015, 0.200, 19.56,  -0.28, 44.6,  0.46,  0.09,  4.3,   109,   88.3, 51.5, 97.3, -3.8,  true,   88.5, 7.8,  3.7,  0   ],
    ["South Africa", "South Africa",     "English",    "ZAR 900,000",      0.56, 0.12, 0.40, 0.60, 0.70, 648, -0.9,  -2.4,  0.5,  0.219, 1.000, 18.98,  0.97,  8.9,   0.49,  0.07,  2.5,   63,    96.2, 66.9, 97.5, -2.4,  true,   82.0, 16.3, 0,    0   ],
    ["Netherlands",  "Netherlands",      "Dutch",      "\u20ac 45.000",         0.53, 0.14, 0.30, 0.60, 0.70, 649, -4.2,  -6.8,  -1.7, 0.004, 0.049, 18.52,  0.19,  96.0,  0.52,  0.01,  0.1,   1,     61.0, 29.0, 97.0, -16.0, false,  99.5, 0.3,  0,    0   ],
    ["Italy",        "Italy",            "Italian",    "45.000 \u20ac",      0.48, 0.14, 0.30, 0.50, 0.70, 650, -8.6,  -11.9, -5.3, 0.001, 0.001, 18.54,  -0.09, 79.0,  0.52,  -0.03, 0.5,   14,    88.5, 24.9, 96.1, -19.5, false,  93.2, 6.8,  0,    0   ],
    ["Switzerland",  "Switzerland",      "German",     "CHF 45'000",       0.53, 0.14, 0.30, 0.60, 0.70, 649, -4.3,  -7.6,  -1.1, 0.016, 0.200, 18.71,  -0.02, 47.5,  0.51,  0.02,  0.2,   5,     84.5, 17.1, 94.3, -21.6, false,  95.2, 0.5,  0,    4.3 ],
    ["Poland",       "Poland",           "Polish",     "200 000 z\u0142",       0.50, 0.14, 0.30, 0.50, 0.70, 650, -7.4,  -10.8, -3.9, 0.001, 0.011, 22.53,  -0.07, 40.6,  0.35,  0.15,  16.3,  408,   74.3, 65.1, 89.3, -16.2, false,  61.1, 38.6, 0,    0   ],
    ["South Korea",  "South Korea",      "Korean",     "7\ucc9c\ub9cc\uc6d0",         0.58, 0.11, 0.40, 0.60, 0.70, 650, 1.4,   -2.8,  5.7,  0.496, 1.000, 18.35,  -0.04, 38.9,  0.53,  0.06,  1.6,   40,    47.2, 33.9, 92.0, -17.3, false,  94.0, 6.0,  0,    0   ],
    ["China",        "China",            "Chinese",    "35\u4e07\u5143",         0.52, 0.10, 0.40, 0.50, 0.65, 649, -4.4,  -8.8,  -0.2, 0.041, 0.371, 19.15,  -0.02, 103.6, 0.48,  0.04,  0.9,   23,    50.9, 13.2, 94.9, -22.7, false,  96.3, 0.2,  0,    0   ],
    ["Mexico",       "Mexico",           "Spanish",    "$1,000,000",    0.54, 0.14, 0.30, 0.60, 0.70, 650, -2.7,  -4.2,  -1.2, 0.001, 0.003, 21.71,  -0.14, 79.6,  0.38,  0.17,  19.5,  489,   95.2, 55.5, 94.1, -1.9,  true,   41.9, 58.1, 0,    0   ],
    ["Turkey",       "Turkey",           "Turkish",    "2 milyon (2.000.000) T\u00fcrk liras\u0131",     0.54, 0.11, 0.40, 0.60, 0.65, 650, -3.1,  -6.5,  -0.1, 0.044, 0.371, 29.08,  0.02,  96.4,  0.21,  0.33,  136.7, 3513,  88.6, 90.0, 98.1, -1.6,  true,   17.5, 66.0, 16.3, 0   ]
  ];
  ...
  var K = {
    ...
    // H12 as the paper reports it: generous vs. limited pension at the
    // risk-averse baseline. The risk x pension interaction (+3.6) makes it
    // +2.6 for a risk-tolerant investor. Every slide renders this string so
    // the same coefficient cannot appear in two different forms.
    betaPensText: "−1.0 pts",
  ...
  var stated = {
    // The no-statement reference the stated-investor estimates are read
    // against: the plain English prompt at the default five-year horizon,
    // pooled over all 21 countries (Version B in the six English-prompting
    // countries, Version B-cross in the other fifteen). Computed from the
    // collection itself, N = 13,645. NOT the US-only Version B mean of 0.569.
    reference: 0.5493,
    risk: {
      averse:   { limited: 0.3045, generous: 0.2944 },
      tolerant: { limited: 0.7674, generous: 0.7931 }
    },
    horizon: { "1": 0.3581, "5": 0.5493, "20": 0.7569 },

    // the sentences themselves, exactly as inserted into the prompt
    say: {
  ...
  var probes = [
    { id: "equityPension", side: "exposed", label: "My pension is invested in stocks",
      statement: "My pension is invested almost entirely in stocks, so its eventual value will rise and fall with equity-market performance.",
      theory: "down", est: -16.9, lo: -21.8, hi: -12.1, p: 0.001, scope: "21 countries" },
    { id: "allWealth", side: "exposed", label: "This is all my liquid wealth",
      statement: "This amount is essentially all of my liquid wealth, and I hold little else in cash or savings for everyday needs and emergencies.",
      theory: "down", est: -23.3, lo: -30.4, hi: -16.1, p: 0.001, scope: "United States" },
    { id: "unhedged", side: "exposed", label: "The fund is not currency-hedged",
      statement: "The stock fund I am considering is a global fund with no currency hedging, so its returns also move with exchange rates.",
      theory: "down", est: -1.3, lo: -3.2, hi: 0.4, p: 0.149, scope: "21 countries" },
    { id: "annuity", side: "safe", label: "My pension is a guaranteed annuity",
      statement: "My pension is a guaranteed, inflation-linked annuity that will pay a fixed real income in retirement regardless of how financial markets perform.",
      theory: "up", est: 4.8, lo: 0.1, hi: 9.6, p: 0.042, scope: "21 countries" },
    { id: "halfWealth", side: "safe", label: "This is half my liquid wealth",
      statement: "This amount is about half of my liquid wealth, and I hold roughly the same again in cash and other safe savings.",
      theory: "up", est: 1.4, lo: -0.4, hi: 3.3, p: 0.109, scope: "United States" },
    { id: "thirdWealth", side: "safe", label: "This is a third of my liquid wealth",
      statement: "This amount is about a third of my liquid wealth, and I hold roughly twice as much in cash and other safe savings.",
      theory: "up", est: 2.5, lo: -0.1, hi: 4.9, p: 0.057, scope: "United States" },
    { id: "hedged", side: "safe", label: "The fund is currency-hedged",
      statement: "The stock fund I am considering is currency-hedged to my home currency, so its returns are not exposed to exchange-rate movements.",
  ...
  // Risk aversion allowed to vary with measured national risk-taking, as the
  // paper specifies it (code/benchmark_model.py, eq:gpsmap):
  //     gamma_c = gammaBar * exp(-eta * (z_c - z_US))
  // The US normalisation matters: at any eta the United States still sits at
  // gammaBar, so eta rotates the panel around the baseline rather than
  // shifting all of it. eta = 0 is the common-preference case.
  var Z_US = 0.12;
  function gammaFor(gammaBar, eta, z) {
    return Math.max(0.5, gammaBar * Math.exp(-eta * (z - Z_US)));
  }
